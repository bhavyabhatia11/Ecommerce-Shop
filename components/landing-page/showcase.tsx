...
export const Showcase = async ({ data }: { data: Section }) => {
  ...
  return (
    <div className="relative items-center justify-center bg-secondary text-primary lg:pb-24">
        ...
        <div className="mt-20 flex w-full flex-col">
          <div className="flex flex-col lg:flex-row">
            ...
            <Ring
              ...
              color="#c4c4c4"
            />
            <div className="relative h-[305px] w-[214px] overflow-hidden rounded-full lg:h-[614px] lg:w-[431px]">
              <Image
            ...
            <div className="mt-20 w-full lg:ml-20 lg:mt-0 lg:w-1/3">
              <div className="z-1 bottom-0 mb-4 flex font-serif text-sm text-neutral-400 lg:text-base">
                {data.subtitle}
              </div>
              <div className="z-1 bottom-0 mb-8 flex text-2xl lg:mb-20 lg:text-5xl">
                {data.title}
              </div>
              <div className="z-1 bottom-0 mb-8 flex w-full items-center gap-4 font-serif text-sm text-neutral-400 lg:mb-0 lg:ml-20 lg:text-base">
                {data.description}
              </div>
